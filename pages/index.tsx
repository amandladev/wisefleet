  ...
  return (
    <>
      ...
      <main className="relative" id="start">
        ...
        >
          <div className="flex flex-col gap-4  justify-self-end md:-mt-20">
            ...
            <div className="flex relative z-10">
              <a className="cursor-pointer" href="https://apps.apple.com/us/app/wisefleet/id1588966610" target={"_blank"}>
                <Image
                  src={"/app-store.svg"}
                  width={200}
                  height={120}
              ...
              <a className="cursor-pointer" href="https://play.google.com/store/apps/details?id=com.wisetrack.wisefleet&pcampaignid=web_share" target={"_blank"}>
                <Image
                  src={"/play-store.svg"}
                  width={200}
                  height={120}
        ...
        <section
          className="py-20 px-3 md:px-24 mt-4 md:mt-0 mb-40"
          id="qna"
        >
          <div className="text-center">
