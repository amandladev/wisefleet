...
export default function Contact() {
  return (
    <section className="min-h-custom2 flex flex-col items-center xl:flex-row px-3 py-20 md:py-3 md:px-24 gap-10 md:mb-1">
      <motion.div 
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      ...
      className="px-8 flex-1">
        <article className="">
          ...
          <div className="flex items-center gap-3 mt-6 mb-10">
            <a className="" href="/brochure.pdf" target={"_blank"}>
